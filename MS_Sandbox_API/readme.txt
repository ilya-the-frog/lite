  ...
  Keystore details
  ----------------
  Filename: Rocketbank_Currency_Converter-sandbox
  ...
  ----------------------
  Java keytool:
  keytool -storetype PKCS12 -list -keystore Rocketbank_Currency_Converter-sandbox.p12 -storepass keystorepassword -v

  OpenSSL:
  openssl pkcs12 -info -in Rocketbank_Currency_Converter-sandbox.p12 -password pass:keystorepassword
